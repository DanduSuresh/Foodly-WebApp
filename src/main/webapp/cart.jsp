...
<body>
	...
	<div class="cart-container">
		...
		<div class="cart-items">
			...
			<div class="cart-item">
				...
				<form action="cart" method="post" class="qty-form">
					...
					<button type="submit" class="qty-btn" name="quantity"
						...
						<%if (item.getQuantity() <= 1) {%> disabled <%}%>>−</button>
			...
			<!-- ⭐ Add More Items (only once) -->
			<div class="add-more-container">
				<a href="menu?restaurantId=<%=restaurantId%>" class="add-btn">+
					Add More Items</a>
			</div>
		...
		<div class="cart-summary">
			...
			<div class="bill-row total">
				<span>To Pay</span> <span>₹ <%=grandTotal + 30%></span>
			</div>

			<a href="placeorder.jsp" class="checkout-btn">PLACE ORDER</a>
		</div>
		<%
		}
		%>
