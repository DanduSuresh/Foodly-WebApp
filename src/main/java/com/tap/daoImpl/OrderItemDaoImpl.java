...
public class OrderItemDaoImpl implements OrderItemDAO {
    ...
    private static final String INSERT =
        "INSERT INTO order_items (orderId, quantity) VALUES (?, ?)";

    private static final String SELECT_BY_ORDER_ID =
        "SELECT * FROM order_items WHERE orderId = ?";

    private static final String SELECT_ALL =
    	    "SELECT OrderItemId, orderId, menuId, quantity, unit_price FROM order_items";



    private static final String UPDATE =
        "UPDATE order_items SET quantity = ? WHERE orderId = ?";
